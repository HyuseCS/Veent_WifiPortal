...
{#if data.devCode}
	<div
		class="mb-5 rounded-xl border-[1.5px] border-brand/40 bg-brand/5 p-3 text-center"
		role="status"
	>
		<p class="text-[11px] font-bold uppercase tracking-wide text-brand">
			Test mode — not sent via SMS
		</p>
