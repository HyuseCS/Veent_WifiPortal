	...
	{#if ap}
		...
		<div class="max-h-[70vh] overflow-y-auto pr-0.5">
			...
			{#if group}
				...
				<div
					class="mt-4 flex flex-col gap-2 rounded-lg border border-border/70 bg-surface/40 p-2.5"
				>
			...
			<dl
				class="mt-4 grid grid-cols-2 gap-2 border-y border-border py-3 text-center sm:grid-cols-4"
			>
