		...
		<div class="flex flex-1 flex-col items-center justify-center px-1 text-center">
			...
			{:else}
				...
				<p class="mb-6 max-w-[280px] text-sm leading-relaxed text-muted">
					This is taking longer than usual — no need to pay again. If your payment went through,
					your credits are added automatically once it clears; just check your balance in a few
					minutes. If you were charged and nothing appears, Maya refunds it automatically.
				</p>
				<div
